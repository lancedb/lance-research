...
df = pd.read_csv(results_dir.joinpath("packed_take.csv"))
...
df = pd.read_csv(results_dir.joinpath("packed_scan.csv"))
...
plt.savefig(charts_dir.joinpath("packed.png"), bbox_inches="tight")
plt.close()
