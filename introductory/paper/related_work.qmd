 ...
 performance of queries based on such formats is orders of magnitude better, compared to row-oriented formats[@column-vs-rows]
 ...
 (e.g. embedded vectors, images, sensor data) for storage. For example, the LAION-5B dataset [@laion-5b] is distributed as a set of Parquet files for metadata columns paired with NumPy binary files for the vector embeddings. Furthermore, such applications require search where performant 
